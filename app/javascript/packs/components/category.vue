                        ...
                        <v-expansion-panel-content>
                          ...
                          <div class="module-contents">
                            ...
                            <v-btn
                              ...
                              elevation="2"
                              outlined
                              v-on:click="updatePopularity(module)"
                            >Activate</v-btn>
                          </div>
                        </v-expansion-panel-content>
                      </v-expansion-panel>
...
export default {
  ...
  methods: {
    ...
    updatePopularity(module) {
      this.$emit('flash', "Activated module " + module.name);
      axios
        .post(Routes.learning_module_update_popularity_path(module.id))
